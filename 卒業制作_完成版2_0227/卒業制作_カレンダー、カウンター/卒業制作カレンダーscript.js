...
window.addEventListener("load", () => {
  ...
  for (let i = 0; i < weeksP2.length; i++) {
    if(i == 0) {
      calendarHtml += '<td id = "tdca" style = "color: red"><p>' + weeksP2[i] + '</td>'
    }
    else if(i == 6) {
      calendarHtml += '<td id = "tdca" style = "color: royalblue"><p>' + weeksP2[i] + '</p></td>'
    }
    else {
      calendarHtml += '<td id = "tdca"><p>' + weeksP2[i] + '<br></p></td>'
    }
  }
  ...
  for (let w = 0; w < 6; w++) {
    ...
    for (let d = 0; d < 7; d++) {
      if (w == 0 && d < startDay) {
          ...
          calendarHtml += '<td id = "tdca" style = "color: #cccccc"><p>' + num + '</p></td>'
        ...
        dayCount++;
          ...
          if(dayCount == day) {
          calendarHtml += '<td id = "tdca" style = "background-color: #090"><p style = "color: white">' + dayCount + '</p></td>';
          dayCount++
          }
          else {
            calendarHtml += '<td id = "tdca"><p>' + dayCount + '</p></td>';
            dayCount++
          }
      }
    }
  ...
  for (let w = 0; w < 6; w++) {
      ...
      for (let d = 0; d < weeks.length + 1; d++) {
        if(d == 0) {
          countzikan++;
          selHtml += '<td id = "tdzi"><p id = "tdzi">時間割' + countzikan + '</p></td>'
        }
        else if(d == 1) {     //月曜日
          if(mozinumber1[w] != "") {
            if(number1[w] >= 4) {   //欠席回数が4回以上なら
              if(mozinumber1[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber1[w].substring(0,3)}</small>` + "..." + '<br><a style = "color: red;">' + number1[w] + '</a></p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber1[w]}</small>` + '<br><a style = "color: red;">' + number1[w] + '</a></p></td>'
              }
            }
            else {
              if(mozinumber1[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber1[w].substring(0,3)}</small>` + "..." + "<br>" + number1[w] + '</p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber1[w]}</small>` + "<br>" + number1[w] + '</p></td>'
              }
            }
          }
          else {
            selHtml += '<td id = "tdju" style = "background-image: linear-gradient(to right top, transparent calc(50% - 0.5px), #cccccc 50%, #cccccc calc(50% + 0.5px), transparent calc(50% + 1px))"></td>'
          }
        }
        else if(d == 2) {     //火曜日
          if(mozinumber2[w] != "") {
            if(number2[w] >= 4) {   //欠席回数が4回以上なら
              if(mozinumber2[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber2[w].substring(0,3)}</small>` + "..." + '<br><a style = "color: red;">' + number2[w] + '</a></p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber2[w]}</small>` + '<br><a style = "color: red;">' + number2[w] + '</a></p></td>'
              }
            }
            else {
              if(mozinumber2[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber2[w].substring(0,3)}</small>` + "..." + "<br>" + number2[w] + '</p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber2[w]}</small>` + "<br>" + number2[w] + '</p></td>'
              }
            }
          }
          else {
          ...
          if(mozinumber3[w] != "") {
            if(number3[w] >= 4) {   //欠席回数が4回以上なら
              if(mozinumber3[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber3[w].substring(0,3)}</small>` + "..." + '<br><a style = "color: red;">' + number3[w] + '</a></p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber3[w]}</small>` + '<br><a style = "color: red;">' + number3[w] + '</a></p></td>'
              }
            }
            else {
              if(mozinumber3[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber3[w].substring(0,3)}</small>` + "..." + "<br>" + number3[w] + '</p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber3[w]}</small>` + "<br>" + number3[w] + '</p></td>'
              }
            }
          }
          else {
          ...
          if(mozinumber4[w] != "") {
            if(number4[w] >= 4) {   //欠席回数が4回以上なら
              if(mozinumber4[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber4[w].substring(0,3)}</small>` + "..." + '<br><a style = "color: red;">' + number4[w] + '</a></p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber4[w]}</small>` + '<br><a style = "color: red;">' + number4[w] + '</a></p></td>'
              }
            }
            else {
              if(mozinumber4[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber4[w].substring(0,3)}</small>` + "..." + "<br>" + number4[w] + '</p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber4[w]}</small>` + "<br>" + number4[w] + '</p></td>'
              }
            }
          }
          else {
          ...
          if(mozinumber5[w] != "") {
            if(number5[w] >= 4) {   //欠席回数が4回以上なら
              if(mozinumber5[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber5[w].substring(0,3)}</small>` + "..." + '<br><a style = "color: red;">' + number5[w] + '</a></p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber5[w]}</small>` + '<br><a style = "color: red;">' + number5[w] + '</a></p></td>'
              }
            }
            else {
              if(mozinumber5[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber5[w].substring(0,3)}</small>` + "..." + "<br>" + number5[w] + '</p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber5[w]}</small>` + "<br>" + number5[w] + '</p></td>'
              }
            }
          }
          else {
          ...
          if(mozinumber6[w] != "") {
            if(number6[w] >= 4) {   //欠席回数が4回以上なら
              if(mozinumber6[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber6[w].substring(0,3)}</small>` + "..." + '<br><a style = "color: red;">' + number6[w] + '</a></p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber6[w]}</small>` + '<br><a style = "color: red;">' + number6[w] + '</a></p></td>'
              }
            }
            else {
              if(mozinumber6[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber6[w].substring(0,3)}</small>` + "..." + "<br>" + number6[w] + '</p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber6[w]}</small>` + "<br>" + number6[w] + '</p></td>'
              }
            }
          }
          else {
          ...
          if(mozinumber7[w] != "") {
            if(number7[w] >= 4) {   //欠席回数が4回以上なら
              if(mozinumber7[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber7[w].substring(0,3)}</small>` + "..." + '<br><a style = "color: red;">' + number7[w] + '</a></p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber7[w]}</small>` + '<br><a style = "color: red;">' + number7[w] + '</a></p></td>'
              }
            }
            else {
              if(mozinumber7[w].length > 3) {   //3文字以上なら
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber7[w].substring(0,3)}</small>` + "..." + "<br>" + number7[w] + '</p></td>'
              }
              else {
                selHtml += '<td id = "tdju"><p>' + `<small>${mozinumber7[w]}</small>` + "<br>" + number7[w] + '</p></td>'
              }
            }
          }
          else {
