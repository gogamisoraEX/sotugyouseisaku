...
const mozi7 = document.querySelector("#name7");
...
window.addEventListener("load", () => {
  const storedMemo = localStorage.getItem('getumemo');
      document.getElementById('memoInput').value = storedMemo;
});

document.getElementById('saveButton').addEventListener('click', function() {
  let getumemo = document.getElementById('memoInput').value;
  localStorage.setItem('getumemo', getumemo);
});

document.getElementById('clearButton').addEventListener('click', function() {
  localStorage.removeItem('getumemo');
  memoInput.value = "";
});
