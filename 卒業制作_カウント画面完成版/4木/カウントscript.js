...
const number21 = document.querySelector(".class20");
const number22 = document.querySelector(".class21");
const number23 = document.querySelector(".class22");
const number24 = document.querySelector(".class23");
...
window.addEventListener("load", () => {
  const storedMemo3 = localStorage.getItem('getumemo3');
      document.getElementById('memoInput3').value = storedMemo3;
});

document.getElementById('saveButton').addEventListener('click', function() {
  let getumemo3 = document.getElementById('memoInput3').value;
  localStorage.setItem('getumemo3', getumemo3);
});

document.getElementById('clearButton').addEventListener('click', function() {
  localStorage.removeItem('getumemo3');
  memoInput3.value = "";
});
