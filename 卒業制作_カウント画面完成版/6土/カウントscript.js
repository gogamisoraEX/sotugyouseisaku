...
window.addEventListener("load", () => {
  const storedMemo5 = localStorage.getItem('getumemo5');
      document.getElementById('memoInput5').value = storedMemo5;
});

document.getElementById('saveButton').addEventListener('click', function() {
  let getumemo5 = document.getElementById('memoInput5').value;
  localStorage.setItem('getumemo5', getumemo5);
});

document.getElementById('clearButton').addEventListener('click', function() {
  localStorage.removeItem('getumemo5');
  memoInput5.value = "";
});
