...
window.addEventListener("load", () => {
  const storedMemo4 = localStorage.getItem('getumemo4');
      document.getElementById('memoInput4').value = storedMemo4;
});

document.getElementById('saveButton').addEventListener('click', function() {
  let getumemo4 = document.getElementById('memoInput4').value;
  localStorage.setItem('getumemo4', getumemo4);
});

document.getElementById('clearButton').addEventListener('click', function() {
  localStorage.removeItem('getumemo4');
  memoInput4.value = "";
});
