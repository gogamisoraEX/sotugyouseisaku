...
window.addEventListener("load", () => {
  const storedMemo6 = localStorage.getItem('getumemo6');
      document.getElementById('memoInput6').value = storedMemo6;
});

document.getElementById('saveButton').addEventListener('click', function() {
  let getumemo6 = document.getElementById('memoInput6').value;
  localStorage.setItem('getumemo6', getumemo6);
});

document.getElementById('clearButton').addEventListener('click', function() {
  localStorage.removeItem('getumemo6');
  memoInput6.value = "";
});
