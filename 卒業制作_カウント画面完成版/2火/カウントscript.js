...
mozi7.addEventListener('input', () => {
  localStorage.setItem('name1', mozi7.value);
});
mozi8.addEventListener('input', () => {
  localStorage.setItem('name2', mozi9.value);
});
mozi9.addEventListener('input', () => {
  localStorage.setItem('name3', mozi9.value);
});
mozi10.addEventListener('input', () => {
  localStorage.setItem('name4', mozi10.value);
});
mozi11.addEventListener('input', () => {
  localStorage.setItem('name5', mozi11.value);
});
mozi12.addEventListener('input', () => {
  localStorage.setItem('name6', mozi12.value);
});
